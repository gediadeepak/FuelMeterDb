        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadingValue = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeterReadings_UserId_FuelType_ReadingDate",
                table: "MeterReadings",
                columns: new[] { "UserId", "FuelType", "ReadingDate" });
        }
